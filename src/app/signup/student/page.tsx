...
- Students must be at least 18 years old to create an independent account.
...
const SAFEGUARDING_TEXT = `Aspire Academic Co. is committed to safeguarding all users.
...
- Lessons may be recorded for quality and safety purposes.`;
  ...
  const handleNext = () => {
    ...
    if (step === 3) {
      if (!formData.idDocumentUrl) {
        setError('ID Document is mandatory for verification.');
        return;
      }
    }
    setError('');
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl w-full bg-white p-8 rounded-3xl shadow-xl ring-1 ring-surface">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-heading">Student Onboarding</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <p className="text-sm text-muted">As an independent student (18+), you must upload a government-issued ID for manual verification.</p>
