  ...
  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="bg-surface/30 rounded-3xl p-8 md:p-16 mb-16 text-center max-w-4xl mx-auto ring-1 ring-surface shadow-sm">
          <div className="text-primary text-5xl mb-6">📚</div>
          <h2 className="text-3xl font-bold mb-8 text-heading">Our Mission</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, i) => (
            <div key={i} className="bg-white p-8 rounded-2xl shadow-sm ring-1 ring-surface text-center transition-transform hover:-translate-y-1">
              <div className="text-4xl mb-6 text-primary">{value.icon}</div>
